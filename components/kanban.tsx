...
// This is a library component from shadcn-kanban-board
// The setState in effect is intentional for mounting state
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isDragging
          ? 'cursor-grabbing active:cursor-grabbing opacity-90 scale-[1.02] rotate-[2deg] shadow-xl'
          : 'group relative',
        isActive && 'rotate-1 transform shadow-lg',
        justDropped && 'animate-kanban-drop',
        className,
      )}
      draggable
      onDragStart={event => {
        ...
        clone.style.boxShadow = '0 8px 25px -5px rgba(0, 0, 0, 0.3)';
        clone.style.borderRadius = '8px';
        clone.style.pointerEvents = 'none';
        document.body.appendChild(clone);
        event.dataTransfer.setDragImage(clone, dragElement.offsetWidth / 2, 20);
