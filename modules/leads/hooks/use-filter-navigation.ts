 ...
 * Extracts common filter/sort logic used across leads components
 */
export function useFilterNavigation() {
  ...
  return {
    ...
    toggleSort,
    // Current values
    currentSort: searchParams.get('sortBy') || 'updated_at',
    currentOrder: (searchParams.get('sortOrder') || 'desc') as 'asc' | 'desc',
  };
}
